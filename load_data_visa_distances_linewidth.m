...
% datapathname = '~/isg/MOABB/lidar_experiments/experiments/data/laser/linewidth/cleo_dec5/result_300m_100u_lowsnr_3.mat';
datapathname = '~/isg/MOABB/lidar_experiments/experiments/data/laser/linewidth/cleo_dec9/result_linewidth_10u_ming_120_noamp.mat';
...
%     solution_lse(i,:) = pnoise_fit_data(10*log10(per_temp_roi),f_roi,[roisize Y 0]);
%     solution_lse(i,:) = pnoise_fit_data((per_temp_roi),f_roi,[roisize Y 0]);
...
alpha = mean(solutions_per)/(352*10/8/3e8);
...
% std(solutions_lse(solutions_lse<3e7))*c/alpha/2
% std(solutions_per(solutions_per<3e7))*c/alpha/2
% % 
% edges=(215:0.25:225);
% figure(2);
% hold on;
% histogram(solutions_per(solutions_per<3e7)*c/alpha/2,edges);
% histogram(solutions_lse(solutions_lse<3e7)*c/alpha/2,edges);
