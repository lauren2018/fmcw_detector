...
stem(fspikes,ones(size(fspikes)),'r','marker','none','LineWidth',2.5)
%stem(tspikes,real(x),'r','marker','none','LineWidth',linewidth)
%plot(tspikes,real(x),'ob','MarkerSize',markersize)
hold on
stem(f_rec_roots,ones(size(fspikes)),'--xb','MarkerSize',markersize,'LineWidth',linewidth)
