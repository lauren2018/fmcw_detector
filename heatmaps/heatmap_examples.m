...
clf
heatmapcus(spreads_small, 1:15, labels_small);

%%
% Labels on the x-axis can be rotated to prevent overlap 
clf
heatmapcus(spreads_small, labels_small, labels_small, [], 'TickAngle', 45);
...
clf
heatmapcus(spreads, labels, labels, [], 'TickAngle', 45,...
...
clf
heatmapcus(spreads_small, labels_small, labels_small, '$%0.2f', 'TickAngle', 45);
...
clf
heatmapcus(spreads_small, labels_small, labels_small, clabel, 'TickAngle', 45);
...
% image.
clf
heatmapcus(spreads_small, labels_small, labels_small, '$%0.2f', ...
...
clf
heatmapcus(spreads_small, [], [], '%0.2f', 'Colormap', 'money', ...
        'Colorbar', true);
...
clf
heatmapcus(spreads_small, [], [], '%0.2f', 'TextColor', 'w', ...
...
subplot(2,1,2);
heatmapcus(spreads_small, [], [], '%0.2f', 'Colormap', 'copper', ...
...
clf
heatmapcus(x,[],[],'%0.2f','ColorMap', @cool, 'Colorbar',true);
snapnow; 

heatmapcus(y,[],[],'%0.2f','ColorMap', @cool, 'Colorbar',true);
%%
...
close(gcf); clf
heatmapcus(c,[],[],[],'ColorMap', @cool, 'NaNColor', [0 0 0], 'colorbar', true);
...
clf
heatmapcus(spreads, [], [], '$%0.2f', 'Colormap', 'money', ...
